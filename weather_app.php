<?php 
    ...
    if($_GET['city']){
        ...
        $urlContents = curl('http://api.openweathermap.org/data/2.5/weather?q='.$_GET['city'].'&appid=a1b7429b78da38b32a22b62ac4a63abf');
        ...
        $windSpeed = round($weatherArray['wind']['speed'] * 2.23694);
        
        $weather .= " The temperater is ".$tempInFahrenheit."&deg;F and the wind speed is ".$windSpeed." mph."; 
    }
?> 
